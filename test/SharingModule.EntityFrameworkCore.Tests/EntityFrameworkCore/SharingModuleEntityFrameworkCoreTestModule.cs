...
[DependsOn(
    typeof(SharingModuleApplicationTestModule),
    typeof(SharingModuleEntityFrameworkCoreModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
    )]
public class SharingModuleEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        var options = new DbContextOptionsBuilder<SharingModuleDbContext>()
            .UseSqlite(connection)
            .Options;

        using (var context = new SharingModuleDbContext(options))
        {
