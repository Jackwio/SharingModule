    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppShareLinks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppShareLinkAccessLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppShareLinkAccessLogs_AppShareLinks_ShareLinkId",
                        column: x => x.ShareLinkId,
                        principalTable: "AppShareLinks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppShareLinkAccessLogs_AccessedAt",
                table: "AppShareLinkAccessLogs",
                column: "AccessedAt");

            migrationBuilder.CreateIndex(
                name: "IX_AppShareLinkAccessLogs_ShareLinkId",
                table: "AppShareLinkAccessLogs",
                column: "ShareLinkId");

            migrationBuilder.CreateIndex(
                name: "IX_AppShareLinks_IsRevoked",
                table: "AppShareLinks",
                column: "IsRevoked");
